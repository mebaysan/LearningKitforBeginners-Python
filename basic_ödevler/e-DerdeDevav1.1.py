print("""
****************************************
e-DerdeDevav1.1 Programına Hoşgeldiniz
****************************************
...
!e-DerdeDeva v1.1 programının tek özelliği tek kullanımlık olmaması siz istediğinizde programdan çıkış yaparsınız onun dışında tek kullanımda kapanmaz!
Hastalıklar:
...
Programdan Çıkmak için : hastalık kodu kısmında "q" tuşlayın veya şifa yöntemi kısmında 1-2 hariç bir numara girin
""")
while True:
	...
	elif(hastalık=="q" and şifayöntemi!=1 or şifayöntemi!=2):
